...
class TranscribeView(ctk.CTkFrame):
    ...
    def create_ui(self):
        ...
        # (NOTA: Ho rimosso la casella del nome file da qui, ora è un popup)
    ...
    def select_file(self):
        ...
        if filename:
            ...
            # (NOTA: Non dobbiamo più aggiornare la casella di testo qui)
    ...
    def start_thread_processing(self):
        ...
        # Calcoliamo un nome di default basato sul file caricato
        ...
        # Se l'utente preme "Annulla" (ritorna None), fermiamo tutto
    ...
    def run_logic(self, api_key, custom_filename):
        try:
            ...
            self.append_text("\n✨ TUTTO COMPLETATO!")
            if self.on_complete_callback: self.after(0, self.on_complete_callback)
